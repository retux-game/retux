...
<tileset name="wm_shallow_water" tilewidth="32" tileheight="32">
 <image source="../images/tiles/tileset_wm_shallow_water.png" width="96" height="160"/>
 <terraintypes>
  <terrain name="shallow_water" tile="14"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
